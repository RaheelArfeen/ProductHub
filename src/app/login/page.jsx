            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-2xl dark:shadow-xl p-8 sm:p-10 flex flex-col border border-gray-200 dark:border-gray-700">
                ...
                <div className="text-center mb-6">
                    <div className="inline-flex items-center justify-center space-x-2 mb-3">
                        ...
                        <span className="font-extrabold text-3xl text-blue-700 dark:text-blue-500">ProductHub</span>
                    </div>
                ...
                <div className="flex-1">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full flex justify-center items-center gap-2 bg-blue-600 dark:bg-blue-500 text-white py-3 rounded-xl font-semibold text-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-300 disabled:opacity-50"
                            disabled={isLoading}
                        >
                    ...
                    <div className="flex items-center my-6">
                        ...
                        <span className="mx-3 text-gray-400 dark:text-gray-500 uppercase text-xs">Or</span>
                        <span className="flex-grow h-px bg-gray-300 dark:bg-gray-600"></span>
                    </div>
